...
namespace Specification
{
...

    {
        ...
        IEnumerable<T> Filter(IEnumerable<T> items, IBaseSpecification<T> spec);

    }

    public class ColorSpecification : IBaseSpecification<Product>
    ...
    public class SizeSpecification : IBaseSpecification<Product>
...

    {
        ...
        public IEnumerable<Product> Filter(IEnumerable<Product> items, IBaseSpecification<Product> spec)
